/*
	The code below encapsulates everything inside
  of a render function. Overall this makes it easier
  to read and allows the render function to be more reuseable.
*/
